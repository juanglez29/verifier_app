...
exports.getdid= async (req, res, next) => {
    try {
      ...
      const resp = await axios.get(`http://localhost:8030/api/wallet/dids/${did}`);
      res.send(resp.data);
  ...
  exports.getschemas = async (req, res, next) => {
    try {
      const resp = await axios.get("http://localhost:8030/api/wallet/credentials/schemas/created");
      res.send(resp.data);
  ...
  exports.getdefinitions = async (req, res, next) => {
    try {
      const resp = await axios.get("http://localhost:8030/api/wallet/credentials/definitions/created");
      res.send(resp.data);
